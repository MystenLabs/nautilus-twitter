...
sleep 5
# Secrets-block
SECRET_VALUE=$(aws secretsmanager get-secret-value --secret-id arn:aws:secretsmanager:us-east-1:094557288217:secret:twitter-api-TrgZMk --region us-east-1 | jq -r .SecretString)
